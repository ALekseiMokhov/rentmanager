...
public class PlaceRepositoryJdbc implements IPlaceRepository {
    ...
    public Place findById(UUID id) {
        ...
        try {
            ...
            statement = connection.prepareStatement( SqlHolder.FIND_PLACE_SQL );
    ...
    public List <Place> findAll() {
        ...
        try {
            connection = factory.getDatasource().getConnection();
            connection.setAutoCommit( false );
            statement = connection.prepareStatement( SqlHolder.FIND_ALL_PLACES_SQL );
            resultSet = statement.executeQuery();
    ...
    public void delete(UUID id) {
        try {
            connection = factory.getDatasource().getConnection();
            statement = connection.prepareStatement( SqlHolder.DELETE_PLACE_SQL );
            statement.setString( 1, String.valueOf( id ) );
    ...
    public void save(Place place) {
        ...
        try {
            connection = factory.getDatasource().getConnection();
            statement = connection.prepareStatement( SqlHolder.SAVE_PLACE_SQL );
